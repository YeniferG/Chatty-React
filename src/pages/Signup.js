        ...
        <div className="card container card-form">
          <form className="mt-5 py-5 px-5" onSubmit={this.handleSubmit}>
            ...
            <div className="form-group">
              <input className="form-control" placeholder="Correo Electronico" name="email" type="email" onChange={this.handleChange} value={this.state.email}></input>
            </div>
            <div className="form-group">
            ...
            <hr/>
            <p>Puedes registrarte con uno de estos servicios</p>
            ...
            <hr></hr>
            <p>¿Ya tienes una cuenta activa? <Link to="/login">Inicia Sesion</Link></p>
          </form>
        </div>
      </div>
    )
